...
- The Bot is provided for entertainment, moderation, and utility purposes on Discord servers.
...
- Do not attempt to exploit, harm, or disrupt the Bot or its services.
- Do not use the Bot to collect or distribute personal information without consent.
- Do not use the Bot for spamming, harassment, or any malicious activity.

## Data and Privacy

- The Bot may collect and store certain data as described in the Privacy Policy.
- By using the Bot, you consent to the collection and use of data as outlined in the Privacy Policy.

## Limitation of Liability

- The Bot is provided "as is" without warranties of any kind.
- The Bot owner is not responsible for any damages or losses resulting from the use or inability to use the Bot.
